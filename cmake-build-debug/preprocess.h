...
void letterbox(const cv::Mat &image, cv::Mat &padded_image, image_rect_t &pads, const float scale, const cv::Size &target_size, const cv::Scalar &pad_color = cv::Scalar(128, 128, 128));
